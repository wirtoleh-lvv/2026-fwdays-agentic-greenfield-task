...
| --- | --- | --- | --- |
| NFR-PRIV-001 | Confirmed Library Books remain in the user's browser and are not persisted by the backend. | accepted | tested |
...
| TC-STORAGE-001 | Confirmed Library Books use browser local persistence. | accepted | tested |
| TC-STORAGE-002 | Library persistence does not depend on an account, cloud sync, or backend storage. | accepted | tested |
